...
- Name: appointment-booking.spec.ts >> Scenario 1: Finding and Booking an Appointment >> opens booking dialog with date picker and time slots
- Location: e2e/appointment-booking.spec.ts:71:7
