...
- Name: appointment-booking.spec.ts >> Scenario 6: Rescheduling / Cancelling >> only patient, doctor (owner), or admin can modify appointment
- Location: e2e/appointment-booking.spec.ts:397:7
