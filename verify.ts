#!/usr/bin/env node
/**
 * verify.ts — Structural checks for Kyntha US bug fixes.
 *
...
const loginPage = read('src/components/kyntha/login-page.tsx');
...
const patientApp = read('src/components/kyntha/patient/patient-app.tsx');
