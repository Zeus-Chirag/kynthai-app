...
const CHALLENGE_TEMPLATES: Omit<
  Challenge,
  'id' | 'currentCount' | 'participants' | 'joined' | 'endsAt'
>[] = [
  {
    title: '5 Journal Entries',
    description: 'Complete 5 health journal entries this week to build self-awareness.',
    type: 'journal',
    targetCount: 5,
  ...
  },
  {
    ...
    description: 'Have 10 meaningful conversations with your AI health assistant.',
    type: 'ai_chat',
    targetCount: 10,
    reward: 'Curious Mind Badge',
    rewardIcon: Trophy,
  },
  {
    title: 'Family Check-in',
    description: 'Check in with 3 family members this week through the care hub.',
    type: 'family',
    targetCount: 3,
    reward: 'Caretaker Badge',
    rewardIcon: Users,
  },
];
        ...
        <CardContent className="p-4 space-y-3">
          ...
          <div className="flex items-start justify-between">
            ...
            <Badge
              ...
              className={cn('text-[10px]', completed && 'bg-emerald-500')}
            >
