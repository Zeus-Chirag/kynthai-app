      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 rounded-lg border border-amber-500/20 bg-amber-500/5 p-3">
              ...
              <div className="text-sm">
                <p className="font-semibold text-foreground">Kyntha is NOT a healthcare provider</p>
                <p className="mt-1 text-muted-foreground">
                  Kyntha is a technology platform only. We do not employ, supervise, or control any
            ...
            <div className="flex items-start gap-3 rounded-lg border border-border/60 bg-background p-3">
              ...
              <div className="text-sm">
                ...
                <p className="mt-1 text-muted-foreground">
                  ...
                  exclusively from this doctor. Kyntha is not liable for any medical negligence,
            ...
            <div className="flex items-start gap-3 rounded-lg border border-border/60 bg-background p-3">
              ...
              <div className="text-sm">
                ...
                <p className="mt-1 text-muted-foreground">
                  ...
                  credentials. Kyntha does not guarantee the quality or accuracy of medical services.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 rounded-lg border border-emerald-500/20 bg-emerald-500/5 p-3">
            ...
            >
              ...
              <span className="font-medium text-foreground">
                Kyntha is a technology platform only and is not a healthcare provider.
              </span>{' '}
              The doctor I am booking is an independent practitioner solely responsible for their
              own medical advice and treatment. I will not hold Kyntha liable for any medical
              negligence, misdiagnosis, or incorrect treatment by this doctor. I understand this
              consultation does not establish a doctor-patient relationship with Kyntha.
            </label>
          </div>
          ...
          <p className="text-xs text-muted-foreground">
            ...
            <strong>911</strong> immediately. Do not use Kyntha for emergency medical care.
          </p>
        </div>
