 ...
 * "Install Kyntha" card. Honours a 7-day dismiss persistence window via
...
const DISMISS_KEY = 'kyntha:install-dismissed'
        ...
        <div className="relative bg-gradient-to-br from-emerald-500 to-teal-600 p-4 text-white">
          ...
          <div className="flex items-start gap-3 pr-6">
            ...
            <div className="flex-1">
              <p className="text-sm font-semibold leading-tight">Install Kyntha</p>
              <p className="mt-1 text-xs opacity-90 leading-snug">
                Add Kyntha to your home screen for faster access, offline support,
