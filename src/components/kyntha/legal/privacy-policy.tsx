...
export function PrivacyPolicy() {
  return (
    <LegalLayout
      ...
      subtitle="How Kyntha collects, uses, and protects your health data."
    ...
    >
      ...
      <p>We collect only the data necessary to operate Kyntha for you and your family:</p>
      <ul>
      ...
      <ul>
        ...
        <li><strong>Colorado — Privacy Act (CPA):</strong> Colorado residents have the right to know what personal data is collected, correct inaccuracies, delete personal data, obtain a copy of their data, and opt out of targeted advertising, profiling, or sale. To exercise these rights, submit a request to privacy@kyntha.app.</li>
        <li><strong>Utah — Consumer Privacy Act (UCPA):</strong> Utah residents may request confirmation of data processing, access to their data, correction of inaccuracies, and deletion of their data. Opt-out rights apply to targeted advertising and sale. Submit requests to privacy@kyntha.app.</li>
        <li><strong>Connecticut — Data Privacy Act (CTDPA):</strong> Connecticut residents have the right to confirm processing, access their data, correct inaccuracies, delete personal data, and opt out of targeted advertising or sale. Requests may be submitted to privacy@kyntha.app.</li>
      </ul>
      <p>
      ...
      <p>
        <strong>Kyntha is not a medical device.</strong> Kyntha is a health-technology
      ...
      <p>
        ...
        clearance, De Novo classification, or PMA approval. Kyntha makes no claims
        of FDA clearance or approval for diagnostic, therapeutic, or monitoring
        functions. The FDA may regulate health software in the future; Kyntha will
      ...
      <p>
        ...
        available through Kyntha are independent healthcare providers. Kyntha does
      ...
      <p>
        Kyntha shares personal data only with the minimum number of processors
        ...
        by emailing <a href="mailto:privacy@kyntha.app" className="text-emerald-600 underline">privacy@kyntha.app</a>.
      </p>
        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody className="text-xs">
            <tr className="border-b border-border/60">
              ...
              <td className="py-2 pr-4">Billing email, subscription tier, payment-intent amount. Card data never reaches Kyntha servers.</td>
            ...
            <tr className="border-b border-border/60">
              ...
              <td className="py-2 pr-4">De-identified chat inputs and symptom text; output returned to Kyntha. Health data is not used to train vendor models.</td>
              <td className="py-2">US</td>
            </tr>
            <tr className="border-b border-border/60">
      ...
      <p>
        ...
        protect the rights, property, or safety of Kyntha, our users, or others.
      </p>
      ...
      <ul>
        <li>
          <strong>Essential cookies:</strong> a single <code>kyntha_session</code>{' '}
      ...
      <p>
        Kyntha uses AI to provide health information, identify medicines, check drug
        ...
        healthcare professional through Kyntha.
      </p>
      <p>
        ...
        <strong>ai-incidents@kyntha.app</strong>. Include the AI feature used, the
      ...
      <p>Kyntha uses AI (large language models, vision models, speech recognition) for chat, symptom analysis, medicine identification, prescription scanning, drug-interaction checking, and insights. These features provide <strong>advisory information only</strong> and do not make automated decisions with legal or similarly significant effects about you. All AI outputs are clearly labelled as AI-generated, and a qualified healthcare professional should be consulted before making medical decisions. You may request human review of any AI-generated output by contacting your doctor or <a href="mailto:hello@kyntha.app" className="text-emerald-600 underline">hello@kyntha.app</a>.</p>
      ...
      <p>
        ...
        Email:{' '}
        <a href="mailto:hello@kyntha.app" className="text-emerald-600 underline">
          hello@kyntha.app
        </a>
        <br />
        Support:{' '}
      ...
      <p>
        Correspondence is handled primarily via email at privacy@kyntha.app. Physical correspondence may be directed to the registered US address in the Terms of Service.
      </p>
    </LegalLayout>
  )
}
    ...
    >
      <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4 mb-6">
        <p className="text-sm text-emerald-800 dark:text-emerald-200">
          <strong>We do not sell your personal information.</strong> Kyntha does not sell, rent, or
      ...
      <p>
        Kyntha does not sell or share personal information. Under CCPA/CPRA, "sale" includes
      ...
      <p>
        ...
        for cross-context behavioural advertising. Kyntha does not engage in this practice.
      ...
      <p>Kyntha complies with applicable state privacy laws to the extent required:</p>
      <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
        <li>
...
export function TermsOfService() {
  return (
    <LegalLayout
      ...
      subtitle="The agreement between you and Kyntha."
      updated="July 13, 2026"
    >
      <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
        <p className="text-sm">
          These Terms govern your use of Kyntha. By creating an account you agree
          to them. If you do not agree, please do not use Kyntha.
        </p>
      </div>
      ...
      <p>
        ...
        jurisdiction) to use Kyntha. Doctors and labs must hold the relevant
      ...
      <ul>
        ...
        <li>You may hold one account per portal unless authorised in writing by Kyntha.</li>
      ...
      <p>
        Kyntha&apos;s AI features (chat, symptom analyzer, medicine identifier,
        ...
        medical advice because of something you read or received from Kyntha.
      </p>
      <p>
        In a medical emergency, call 911 (United States) immediately. Do not rely on Kyntha
        for emergency response.
      </p>


      <SectionTitle icon={Crown}>4. Subscription & billing</SectionTitle>
      <p>Kyntha offers the following subscription tiers:</p>
      <ul>
      ...
      <p>All prices shown are the full charge — no hidden fees or surprise charges.
        ...
        or by contacting hello@kyntha.app. Your subscription remains active until the end of your
      ...
      <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 p-4">
        <p className="text-sm">
          <strong>Important:</strong> Kyntha is a <strong>technology connector
          ...
          Kyntha does not employ, supervise, or control the medical
          decision-making of any doctor or healthcare professional using the
          platform. Kyntha&apos;s role is limited to providing technology
          ...
          applicable US consumer protection laws, Kyntha
          provides only technology/connectivity services — not healthcare services.
          Any claim that Kyntha owes a duty of care in the nature of a healthcare
          provider is expressly denied.
        </p>
      </div>
      <p>
        All doctors, healthcare professionals, and labs available through Kyntha
        are <strong>independent practitioners</strong>. When you consult a doctor
        through Kyntha, you are entering into a direct doctor-patient
        relationship with that independent professional — <strong>not</strong>
        with Kyntha Health Technologies. By using Kyntha, you acknowledge and
        agree that:
      </p>
      <ul>
        ...
        Kyntha.</li>
        <li>Kyntha does not verify, endorse, or guarantee the quality, accuracy,
        ...
        licensing, and credentials of any doctor you consult through Kyntha.</li>
        <li>Kyntha&apos;s role is limited to providing the technology
        infrastructure that facilitates your connection with independent doctors.</li>
        <li><strong>Under no circumstances is Kyntha liable</strong> for any
      ...
      <p>
        <strong>Sole responsibility of doctors.</strong> Kyntha is{' '}
      ...
      <p>
        ...
        and healthcare professionals using Kyntha <strong>must</strong> maintain
        ...
        as a doctor on Kyntha, you represent and warrant that you hold valid
        professional indemnity insurance and will maintain it throughout your use
        of the platform. Kyntha reserves the right to request proof of insurance
      ...
      <p>
        ...
        by applicable law, Kyntha shall not be held vicariously liable for the
        ...
        Kyntha shall not be named as a party to any dispute between a patient
        and a doctor, and Kyntha will not indemnify or compensate any party for
      ...
      <p>
        ...
        acknowledge and agree through Kyntha&apos;s mandatory liability
        acknowledgment screen that (a) Kyntha is a technology platform only and
        ...
        (c) Kyntha is not liable for any medical negligence, misdiagnosis, or
      ...
      <p>
        Kyntha reserves the right to <strong>immediately suspend or permanently
      ...
      <p>
        Kyntha will investigate complaints promptly and may cooperate with
      ...
      <ul>
        <li>Use Kyntha for any unlawful purpose or in violation of these Terms.</li>
      ...
      <div className="rounded-xl border border-blue-500/20 bg-blue-500/5 p-4">
        <p className="text-sm">
          ...
          professional fees between you and Kyntha. It does not constitute
      ...
      <p>
        ...
        routed through Kyntha (you keep 85%). Labs pay an 18% platform fee on
      ...
      <p>
        ...
        hello@kyntha.app. Cancellation takes effect at the end of the current
      ...
      <p>
        ...
        <a className="text-emerald-600 underline" href="mailto:hello@kyntha.app">
          hello@kyntha.app
        </a>{' '}
      ...
      <p>
        <strong>Trademarks.</strong> &quot;Kyntha&quot; and the Kyntha logo are
        trademarks of Kyntha Health Technologies (trademark registration pending).
      ...
      <p>
        <strong>Software &amp; content.</strong> Kyntha and all its software,
        design, branding, and original content are the intellectual property of
        Kyntha Health Technologies. The software is built on open-source
      ...
      <p>
        ...
        you grant Kyntha a worldwide, non-exclusive, royalty-free licence to
      ...
      <p>
        Kyntha is provided &quot;as is&quot; and &quot;as available&quot; without
        ...
        that AI-generated results are accurate or complete. You use Kyntha at
        your own risk.
      </p>

      <SectionTitle icon={AlertTriangle}>13. Limitation of liability</SectionTitle>
      <p>
        To the maximum extent permitted by law, Kyntha shall not be liable
      ...
      <p>
        You agree to indemnify and hold harmless Kyntha from any claims,
      ...
      <p>
        If you believe content on Kyntha infringes your copyright, send a
        takedown notice to <a className="text-emerald-600 underline" href="mailto:hello@kyntha.app">hello@kyntha.app</a>{' '}
      ...
      <p>
        ...
        you and Kyntha agree to resolve any claim or controversy (except for
      ...
      <p>
        <strong>Class action waiver.</strong> You and Kyntha agree that each
      ...
      <p>
        <strong>Limitation period.</strong> You and Kyntha agree that any claim
      ...
      <p>
        ...
        Terms or your use of Kyntha, subject to the arbitration clause above.
      </p>

      <SectionTitle icon={FileText}>18. Force majeure</SectionTitle>
      <p>
        Kyntha shall not be liable for any failure or delay in performance caused
      ...
      <p>
        ...
        or your account without Kyntha&apos;s prior written consent. Kyntha may
      ...
      <p>
        ...
        entire agreement between you and Kyntha regarding the service, and
      ...
      <p>
        You agree not to use, export, re-export, or transfer Kyntha in violation
        of any applicable export control laws, including applicable US export-control regulations and sanctions administered by
        the US Department of Commerce and the US Department of the Treasury. Kyntha is not available in
      ...
      <p>
        <strong>Kyntha Health Technologies</strong><br />
        Registered: United States (please email privacy@kyntha.app for legal/privacy correspondence)<br />
        Email:{' '}
        <a href="mailto:hello@kyntha.app" className="text-emerald-600 underline">
          hello@kyntha.app
        </a>
        ...
        <br />
        <br />
        Postal address: United States (handled via email: privacy@kyntha.app)<br />
      </p>
    </LegalLayout>
  )
}
...
export function CookiePolicy() {
  return (
    <LegalLayout
      title="Cookie Policy"
      subtitle="How the Kyntha platform uses cookies and local storage."
      updated="July 13, 2026"
    >
      <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
        <p className="text-sm">
      ...
      <p>
        ...
        provide information to site owners. The Kyntha platform uses cookies and local
      ...
      <ul>
        <li>
          ...
          cannot log in or use  Kyntha . These do not require consent under
      ...
      <p>
        On your first visit, the Kyntha platform shows a cookie consent banner. You may
...
export function AccessibilityStatement() {
  return (
    <LegalLayout
      ...
      subtitle="Kyntha&apos;s commitment to digital accessibility."
      updated="July 13, 2026"
    >
      <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
        <p className="text-sm">
          Kyntha is committed to making our platform accessible to all users,
      ...
      <p>
        Kyntha is partially conformant with WCAG 2.1 Level AA. Some content may
      ...
      <p>
        The Kyntha platform is evaluated using:
      </p>
      <ul>
      ...
      <p>
        We welcome your feedback on the accessibility of Kyntha. Please contact
        us at <a href="mailto:hello@kyntha.app" className="text-emerald-600 underline">hello@kyntha.app</a>.
...
export function MedicalDisclaimer() {
  return (
    <LegalLayout
      ...
      subtitle="Important information about the Kyntha health features."
      updated="July 13, 2026"
    >
      <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 p-4">
        <p className="text-sm">
          <strong>Please read this disclaimer carefully before using any
          health-related feature of Kyntha.</strong>
        </p>
      </div>

      <SectionTitle icon={AlertTriangle}>1. Not a substitute for professional medical advice</SectionTitle>
      <p>
        Kyntha is a health-management platform that provides tools for tracking
        medications, scheduling consultations, managing lab results, and
        accessing AI-powered health information. Kyntha does <strong>not</strong>
      ...
      <p>
        ...
        advice because of something you read or received from Kyntha.
      </p>

      <SectionTitle icon={AlertTriangle}>3. No doctor-patient relationship with Kyntha</SectionTitle>
      <p>
        Kyntha is a technology platform only. It is not a healthcare provider.
        Any advice, diagnosis, or treatment you receive through a doctor
        consultation on Kyntha comes from that independent doctor, not from
        Kyntha. Kyntha is not responsible for the quality, accuracy, or safety
      ...
      <p>
        ...
        Do not rely on Kyntha for emergency response.
      </p>
      <ul>
      ...
      <p>
        Kyntha&apos;s Emergency SOS feature notifies your contacts and doctors,
      ...
      <p>
        When you consult a doctor through Kyntha, you enter into a direct
        doctor-patient relationship with that <strong>independent practitioner</strong>.
        Kyntha is not responsible for:
      </p>
      <ul>
      ...
      <p>
        ...
        dispute arising from your use of Kyntha&apos;s health features shall
