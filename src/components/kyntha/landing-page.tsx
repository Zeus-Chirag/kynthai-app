  ...
  return (
    <section id="bento-features" className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-3 text-muted-foreground">
          Ask, snap, type — Kyntha turns everyday moments into
          ...
          <Card className="h-full border-amber-500/20 bg-gradient-to-br from-amber-500/10 via-card to-emerald-500/5">
            <CardContent className="flex flex-col items-start gap-4 p-6 sm:flex-row sm:items-center sm:p-8">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1.5 text-sm text-muted-foreground">
                  Kyntha cross-checks every active medication for drug-drug, drug-food and timing
    ...
    <section className="relative overflow-hidden border-y border-border/60 bg-gradient-to-b from-emerald-500/5 via-background to-teal-500/5">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            We&apos;re building Kyntha in the open. No fake reviews, no inflated numbers —
      ...
      <div className="mx-auto max-w-3xl">
        <div className="mx-auto max-w-2xl text-center mb-10">
          ...
          <p className="mt-3 text-muted-foreground">
            ...
            paper schedules. Kyntha brings everything into one place.
          </p>
        </div>
          ...
          <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
            ...
            <div>
              ...
              <div className="space-y-3 text-sm leading-relaxed text-foreground/80">
                <p>
                  We built Kyntha because medication management for families is broken. 
  ...
  return (
    <section className="border-y border-border/60 bg-gradient-to-b from-emerald-500/[0.03] to-teal-500/[0.03] py-16 lg:py-20">
      <div className="mx-auto max-w-2xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
          Kyntha is live <span className="text-emerald-600">for US families</span>
        </h2>
        <p className="mt-3 text-muted-foreground">
      ...
      <div className="mx-auto max-w-2xl px-4 text-center sm:px-6 lg:px-8">
        ...
        {submitted ? (
          <div className="mt-8 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-6">
            ...
            <p className="mt-1 text-sm text-muted-foreground">We&apos;ll send occasional updates about Kyntha.</p>
          </div>
        ) : (
        ...
        <p className="mt-4 text-xs text-muted-foreground">
          Already using Kyntha? You&apos;re on the waitlist — <button onClick={() => onGetStarted('login')} className="text-emerald-600 underline">sign in</button> to manage your preferences.
        </p>
      </div>
    </section>
  )
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div>
            <div className="mx-auto max-w-2xl text-center lg:text-left lg:mx-0 mb-10">
              ...
              <p className="mt-3 text-muted-foreground">
                We&apos;re not here to sell you on fake numbers. Kyntha is a new kind of health app —
      ...
      <div className="mx-auto mt-10 grid max-w-4xl gap-5 sm:grid-cols-2">
        ...
        <Card className="relative overflow-hidden border-teal-500/30 bg-gradient-to-br from-teal-500/10 via-card to-emerald-500/5">
          <CardContent className="p-7">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Transparent fees on every test booking fulfilled through Kyntha&apos;s network.</p>
