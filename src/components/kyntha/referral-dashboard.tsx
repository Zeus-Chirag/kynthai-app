...
export function ReferralDashboard() {
  ...
  const shareText = data?.code
    ? `Join me on Kyntha — an AI-assisted health app for families. Use my code ${data.code} for exclusive early pricing.`
    : 'Join Kyntha — an AI-assisted health app for families.'
      ...
      <CardHeader className="pb-3">
        <CardTitle className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground font-normal">Share Kyntha, unlock rewards</p>
          </div>
        </CardTitle>
      </CardHeader>
