...
const CONSENT_KEY = 'kyntha-cookie-consent-v1'
...
function setStoredConsent(accepted: boolean) {
  ...
  window.dispatchEvent(new CustomEvent('kyntha-consent-change', { detail: { accepted } }))
}
...
export function CookieConsent() {
  ...
  React.useEffect(() => {
    ...
    if (stored) {
      window.dispatchEvent(new CustomEvent('kyntha-consent-change', { detail: { accepted: stored.accepted } }))
    }
  }, [pathname])
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-1 text-xs text-muted-foreground leading-relaxed">
                Kyntha uses essential cookies for authentication and local
