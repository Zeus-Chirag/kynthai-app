...
// Returns a printable HTML prescription with Kyntha branding.
...
<head>
  ...
  <title>Prescription — Kyntha</title>
  <style>
    @media print {
      body { margin: 0; }
...
<body>
  <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;">
    <div>
      <h1 style="font-size:24px;font-weight:700;color:#059669;">Kyntha</h1>
  ...
  <p style="margin-top:24px;text-align:center;font-size:10px;color:#9ca3af;">
    Generated by Kyntha · ${dateStr} · Rx#${prescription.id.slice(0, 8).toUpperCase()}
  </p>
</body>
</html>`
