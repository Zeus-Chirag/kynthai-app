    ...
    "@graph": [
      {
        ...
        logo: BASE + "/logo.png",
        description:
          "Kyntha is an AI-powered health companion for American families, offering medicine reminders, health tracking, doctor video consultations, lab test bookings, and family health management, HIPAA-aligned, US-hosted.",
        address: {
          "@type": "PostalAddress",
      ...
      },
      {
        ...
        description:
          "AI-powered medicine reminders, doctor video consultations, lab tests and family health management for US households. Free to start, HIPAA-aligned, encrypted.",
