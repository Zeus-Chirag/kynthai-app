 ...
 * kynthai-init-db.mjs
 *
 * Creates all Supabase tables, enums, RLS policies, and triggers for Kynthai.
 *
 * Usage:
 *   node kynthai-init-db.mjs
 *
...
async function seedData() {
  ...
  const demoAccounts = [
    { email: 'patient@demo.kynthai.app', password: 'Demo@2024', name: 'Jane Cooper', role: 'patient' },
    { email: 'caretaker@demo.kynthai.app', password: 'Demo@2024', name: 'Priya Patel', role: 'caretaker' },
    { email: 'priya@demo.kynthai.app', password: 'Demo@2024', name: 'Dr. Priya Sharma', role: 'doctor' },
    { email: 'pathlabs@demo.kynthai.app', password: 'Demo@2024', name: 'PathLabs Diagnostic', role: 'lab' },
    { email: 'admin@demo.kynthai.app', password: 'Demo@2024', name: 'Admin User', role: 'admin' },
  ]
