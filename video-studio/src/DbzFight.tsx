    ...
    <AbsoluteFill style={{ backgroundColor: "#0a0000", overflow: "hidden" }}>
      <Sequence from={0}>
        <AbsoluteFill
          style={{
            background:
              "radial-gradient(circle at 30% 30%, rgba(255,0,0,0.25), transparent 55%),               radial-gradient(circle at 70% 70%, rgba(255,255,255,0.15), transparent 55%),               linear-gradient(180deg, #1a0000 0%, #330000 50%, #0a0000 100%)",
