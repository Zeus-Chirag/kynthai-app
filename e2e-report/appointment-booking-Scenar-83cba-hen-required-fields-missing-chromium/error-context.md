...
- Name: appointment-booking.spec.ts >> Scenario 4: Appointment Confirmation >> submit button disabled when required fields missing
- Location: e2e/appointment-booking.spec.ts:214:7
