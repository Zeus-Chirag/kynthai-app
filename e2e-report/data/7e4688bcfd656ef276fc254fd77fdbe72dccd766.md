...
- Name: appointment-booking.spec.ts >> Scenario 2: Selecting Time Slots >> CRITICAL: shows same time slots for ALL doctors (not per-doctor)
- Location: e2e/appointment-booking.spec.ts:139:7
